...
const buildSellerProfileStyles = (c) =>
  ...
  cancelBtn: { flex: 1, paddingVertical: 13, borderRadius: radius.xl, backgroundColor: "rgba(255,255,255,0.3)", alignItems: "center" },
  cancelText: { fontWeight: "700", color: c.light },
  saveBtn: { flex: 2, paddingVertical: 13, borderRadius: radius.xl, alignItems: "center", justifyContent: "center" },
  saveText: { color: c.light, fontWeight: "700", fontSize: 15 },
  editBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 11, paddingHorizontal: 20, borderRadius: radius.xl, marginTop: 4 },
  ...
  chip: { paddingHorizontal: 14, paddingVertical: 9, borderRadius: radius.xl, borderWidth: 1.5, borderColor: c.border, backgroundColor: "#FAFBFC" },
