...
const buildPaymentsStyles = (c) =>
  ...
  setupTypeBtnActive: { borderColor: c.primary, backgroundColor: c.surface },
  ...
  bankOptionActive: { backgroundColor: c.surface },
  ...
  setupSubmitText: { color: c.light, fontWeight: "700", fontSize: 15 },
 });
